...
import static com.ujcms.common.lucene.HighlightDocument.FIELD_BODY;
import static com.ujcms.common.lucene.HighlightDocument.FIELD_TITLE;
...
public class LuceneOperations {
    ...
    public <T extends HighlightDocument> Page<T> page(Query query, Pageable pageable, @Nullable Sort sort, int fragmentSize,
