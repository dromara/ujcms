...
public class ChannelBufferService {
    ...
    public List<ChannelBuffer> selectList(@Nullable Map<String, Object> queryMap) {
        QueryInfo queryInfo = QueryParser.parse(queryMap, ChannelBuffer.TABLE_NAME, "id_desc");
    ...
    public Page<ChannelBuffer> selectPage(@Nullable Map<String, Object> queryMap, int page, int pageSize) {
