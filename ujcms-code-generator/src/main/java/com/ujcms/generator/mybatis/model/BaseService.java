...
public class BaseService extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        topLevelClass.addImportedType("com.ujcms.common.query.QueryInfo");
        topLevelClass.addImportedType("com.ujcms.common.query.QueryParser");
        // topLevelClass.addImportedType("com.ujcms.cms.core.service.SeqService");
        topLevelClass.addImportedType("com.ujcms.common.db.identifier.SnowflakeSequence");
        topLevelClass.addImportedType("org.springframework.stereotype.Service");
        // @Service 注解
        ...
        // moveOrder 方法
        if ("true".equalsIgnoreCase(introspectedTable.getTableConfigurationProperty("order"))) {
            topLevelClass.addImportedType("com.ujcms.common.db.order.OrderEntityUtils");
